...
from sklearn.feature_selection import mutual_info_regression, SelectorMixin
    ...
    def transform(self, X):
        if isinstance(X, pandas.DataFrame):
            ...
            if self._feature_selector is None:
                ...
                X2 = pandas.DataFrame(X2, index=X.index,
                                      columns=X_outside.columns[self._feature_selector.get_support()])
